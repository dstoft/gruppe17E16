...
public enum CommandWord
{
     ...
     */
    GO("go"), QUIT("quit"), HELP("help"), DROP("drop"), PRINT("print"), SCAN("scan"), UNKNOWN("?"), SAY("say"), GREET("greet");
    ...
    /**
     * Makes each object of the enum printable, it prints the line typed in by the user
