...
public class Question {
    ...
    /**
     * The constructor sets the attributes qText and numOfAns, according to the
     * given parameters. In addition is the attribute currentAnswer set, and the
     * ArrayList answers is constructed.
     *
